...
INSERT INTO `Doctors` VALUES('D102104', '이사부', '1966-09-12', 'M', '102', '전문의','010-2104-1996', 'leesabu@bw.com');
...
INSERT INTO `Nurses` VALUES('N102101', '102', '이영애', '1976-07-21', 'F',  '수간호사', '010-1102-7507', 'yung@bw.com');
INSERT INTO `Nurses` VALUES('N102102', '102', '엄정화', '1976-06-30', 'F',  '주임', '010-1103-8906', 'um@bw.com');
INSERT INTO `Nurses` VALUES('N102103', '102', '박명수', '1976-05-13', 'M',  '주임', '010-2101-7905', 'park@bw.com');
INSERT INTO `Nurses` VALUES('N103101', '103', '정준하', '1976-10-12', 'M',  '주임', '010-2104-6610', 'jung@bw.com');
INSERT INTO `Nurses` VALUES('N104101', '104', '김대희', '1976-08-28', 'F',  '주임', '010-3101-7908', 'taeh@bw.com');
INSERT INTO `Nurses` VALUES('N105101', '105', '송혜교', '1976-07-15', 'F',  '주임', '010-4101-8407', 'song@bw.com');
INSERT INTO `Nurses` VALUES('N106101', '106', '공유', '1976-11-21', 'M',  '수간호사', '010-5101-7511', 'gong@bw.com');
INSERT INTO `Nurses` VALUES('N107101', '107', '이병헌', '1976-12-28', 'M',  '수간호사', '010-6101-7212', 'byung@bw.com');
INSERT INTO `Nurses` VALUES('N108101', '108', '송중기', '1976-10-07', 'M',  '수간호사', '010-7103-9210', 'jungi@bw.com');
...
INSERT INTO `Charts` VALUES('C1021001', 1021001, 'D102101', 'P102101', '감기 주사 및 약처방');
...
INSERT INTO `patients`(`pat_id`, `doc_id`, `nur_id`, `pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_email`, `pat_job`)VALUES ('P105101', 'D105101', 'N105101', '원빈', '660912-1234567', 'M','대전', '010-2104-6609', 'one@naver.com','배우' );
...
INSERT INTO `patients`(`pat_id`, `doc_id`, `nur_id`, `pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_email`, `pat_job`)VALUES ('P104102', 'D104101', 'N104101', '고서영', '840615-1234567', 'F','대구', '010-4101-8406', 'goso@daum.com','회사원' );
INSERT INTO `patients`(`pat_id`, `doc_id`, `nur_id`, `pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_email`, `pat_job`)VALUES ('P108101', 'D108101', 'N108101', '김연아', '651021-1234567', 'F','대구', '010-5101-6510', 'yuna@daum.com','운동선수' );
...
#문제6
#모든 진료 내역에서 화상으로 진료한 내역 가운데 진료번호, 환자이름, 담당의사명, 
#진료내용, 처방내용, 진료 날짜를 조회하시오
...
#문제 8 모든 전공부서에서 아직 의사 ID가 부여받지 않은 의사의 이름과 부서명 조회
SELECT 
	`doc_name`,
	`dep_name`
...
#문제 9 김태희 간호사가 맡고 있는 모든 환자의 이름을 구분자 ^으로 해서 강동원^고소영
SELECT GROUP_CONCAT(pat_name SEPARATOR '^') AS `환자이름`
FROM `patients` AS a 
JOIN `nurses`   AS b 
USING (nur_id)
WHERE nur_name = '김대희';

#문제 10 가장 많은 환자 수를 담당하는 간호사 ID, 간호사 이름, 담당환자수를 조회 하시오 
SELECT 
	a.nur_id,
	nur_name,
	COUNT(*) AS `환자 수`
