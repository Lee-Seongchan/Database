...
INSERT INTO `User2` (`uid`, `name`, `hp`, `age`) VALUES ('B101', '김유신', '010-1234-1111', 25);							
...
DROP TABLE `USER5`;
#실습 2-10
INSERT INTO `User5` (`name`, `gender`, `addr`)VALUES( '장보고', 1, '완도시');
INSERT INTO `User5` (`name`, `gender`, `addr`)VALUES( '강감찬', 1, '서울시');
...
ALTER TABLE `User6` DROP `age`;

DROP TABLE `User6`;
user6SELECT * FROM `User6`;
INSERT INTO `User6`(name) SELECT `name` FROM `User5`;
