...
INSERT INTO `bank_customer` VALUES ('220-82-52237', '(주)한국전산', 2, '051-134-1045', '서울시 강서구');
INSERT INTO `bank_customer` VALUES ('361-22-42687', '(주)정보산업', 2, '031-563-1253', '경기도 광명시');
INSERT INTO `bank_customer` VALUES ('730423-1000001', '김유신', 1, '051-1234-1001', '경기도 수원시');
INSERT INTO `bank_customer` VALUES ('750210-1000002', '김춘추', 1, '051-1234-1002', '경기도 광주시');
INSERT INTO `bank_customer` VALUES ('830513-2000003', '선덕여왕', 1, '051-1234-1003', '서울시 마포구');
INSERT INTO `bank_customer` VALUES ('870830-1000004', '강감찬', 1, '051-1234-1004', '서울시 영등포구');
INSERT INTO `bank_customer` VALUES ('910912-2000005', '신사임당', 1, '051-1234-1005', '강원도 강릉시');
INSERT INTO `bank_customer` VALUES ('941127-1000006', '이순신', 1, '051-1234-1006', '부산시 영도구');

INSERT INTO `bank_account` VALUES ('101-11-1001', 'S1', '자유저축예금', '730423-1000001', 420000, '2005-07-21');
INSERT INTO `bank_account` VALUES ('101-11-1003', 'S1', '자유저축예금', '870830-1000004', 53000, '2005-02-17');
INSERT INTO `bank_account` VALUES ('101-11-2001', 'S1', '자유저축예금', '220-82-52237', 23000000, '2005-04-14');
INSERT INTO `bank_account` VALUES ('101-11-2002', 'S1', '자유저축예금', '361-22-42687', 4201000, '2005-12-30');
INSERT INTO `bank_account` VALUES ('101-11-2003', 'S1', '자유저축예금', '102-22-51094', 8325010, '2005-06-07');
INSERT INTO `bank_account` VALUES ('101-12-1002', 'S2', '정기적립예금', '830513-2000003', 1020000, '2005-05-13');
INSERT INTO `bank_account` VALUES ('101-13-1005', 'S3', '주택청약예금', '941127-1000006', 720800, '2005-10-15');
INSERT INTO `bank_account` VALUES ('101-21-1004', 'L1', '고객신용대출', '910912-2000005', 1200500, '2005-08-25');
INSERT INTO `bank_account` VALUES ('101-22-1006', 'L2', '예금담보대출', '730423-1000001', 25000, '2005-12-11');
INSERT INTO `bank_account` VALUES ('101-23-1007', 'L3', '주택담보대출', '780210-1000002', 2700000, '2005-09-23');
...
#실습 2-15 
SELECT SUM(`t_amount`) AS `입금총합`, AVG(`t_amount`) AS `입급평균`
FROM `bank_transaction`
WHERE `t_dist` = 1;
...
FROM `bank_account`
WHERE `a_item_name` = '자유저축예금' 
AND  `a_balance` = (SELECT MAX(`a_balance`) FROM `bank_account`)
ORDER BY `a_balance` DESC
...
#실습 2-30 
# 8버전 sql에서는 group by 절에서 선택된 칼럼과 집계함수만 select 가능

SELECT ANY_VALUE(`t_no`),
		 ANY_VALUE(`a_no`),
		 			  `c_no`,
